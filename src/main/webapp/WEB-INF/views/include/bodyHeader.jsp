<%@page import="com.jade.myapp.board.service.impl.BoardCategoryService"%>
<%@page import="java.util.List"%>
<%@page import="com.jade.myapp.board.model.BoardCategory"%>
<%@page import="com.jade.myapp.board.service.IBoardCategoryService"%>
...
<div id="divHeaderWrapper">
    ...
    <div class="navbar navbar-wp navbar-arrow mega-nav" role="navigation">
        <div class="navbar-header">
            ...
            </a><div style="padding-left:15px; width:200px">http://www.jade.com</div>
        </div>
