...
public class BoardController {
	...
	@RequestMapping("/board/cat/{cagegoryId}/{page}")
	...
	public String writeArticle(@PathVariable int categoryId, Model model) {
		List<BoardCategory> categoryList = categoryService.selecetAllCategory();
	...
	public String writeArticle(Board board, BindingResult result, RedirectAttributes redirectAttrs) {
		...
		try {
			...
			if (mfile != null && !mfile.isEmpty()) {
				...
				file.setFileDate(mfile.getBytes());
	...
	public String replyArticle(Board board, BindingResult result, RedirectAttributes redirectAttrs,
			HttpSession session) {
